  ...
  _createClass(TouchableComponent, [{
    ...
    value: function swipeEnd(e) {
      ...
      if (time > this.maxTime) {
        console.log('--- TOUCHABLE COMPONENT MAX TIME', time + ' > ' + this.maxTime);
        return;
      }
      ...
      if (distance < this.minDistance) {
        console.log('--- TOUCHABLE COMPONENT MIN DISTANCE', distance + ' > ' + this.minDistance);
        return;
      }
      console.log('--- TOUCHABLE COMPONENT SWIPE DIRECTION', direction);
      this.props.setProps({
        swipe: direction,
        swipe_end: e.timeStamp
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=c9b3f3e-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJjOWIzZjNlLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==