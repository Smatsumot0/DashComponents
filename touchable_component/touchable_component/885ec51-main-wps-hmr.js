...
var TouchableComponent = /*#__PURE__*/function (_Component) {
  ...
  _createClass(TouchableComponent, [{
    ...
    value: function swipeEnd() {
      ...
      // 最小距離以下の場合 何もしない
      if (info.isShort) {
        console.log('--- TOUCHABLE COMPONENT MIN DISTANCE', info.distance + ' > ' + this.minDistance);
        return;
      }
      console.log('--- TOUCHABLE COMPONENT SWIPE DIRECTION', info.direction);
      this.props.setProps({
        swipe: info.direction,
        swipe_end: Date.now()
      });
    }
    ...
    value: function getSwipeInfo() {
      if (!this.endPos || !this.startPos) return null;
      var x = this.endPos.x - this.startPos.x;
      var y = this.endPos.y - this.startPos.y;
      var time = e.timeStamp - this.startPos.timeStamp;
      this.startPos = null;
      this.endPos = null;
      ...
      return {
        ...
        direction: direction,
        distance: distance,
        isTimeOver: info.time > this.maxTime,
        isShort: info.distance < this.minDistance
      };
    }
  }, {
    key: "render",
...
//# sourceMappingURL=885ec51-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI4ODVlYzUxLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==