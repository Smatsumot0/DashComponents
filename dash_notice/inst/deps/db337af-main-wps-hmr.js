...
var DashNotice = /*#__PURE__*/function (_Component) {
  ...
  function DashNotice(props) {
    ...
    // set
    var notices = JSON.parse(sessionStorage.getItem(_this2.key));
    if (!notices) notices = [];
    notices = Array.from(new Set(notices.concat(_this2.props.notices)));
    console.log(notices);
...
//# sourceMappingURL=db337af-main-wps-hmr.js.map
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJkYjMzN2FmLW1haW4td3BzLWhtci5qcyIsInNvdXJjZVJvb3QiOiIifQ==